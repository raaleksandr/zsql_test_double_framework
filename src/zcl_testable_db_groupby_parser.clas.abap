class ZCL_TESTABLE_DB_GROUPBY_PARSER definition
  public
  create public .
...
CLASS ZCL_TESTABLE_DB_GROUPBY_PARSER IMPLEMENTATION.
  ...
  method PARSE_GROUP_BY.
    ...
    IF iv_group_by_clause IS NOT INITIAL.
      SPLIT zcl_testable_db_layer_utils=>to_upper_case( iv_group_by_clause ) AT space INTO TABLE lt_group_by_fields.
    ENDIF.
    ...
    LOOP AT lt_group_by_fields INTO lv_group_by_field.
      ...
      IF sy-subrc = 0.
        SPLIT lv_group_by_field AT '~' INTO zcl_testable_db_layer_utils=>dummy <ls_group_by_field>-fieldname.
      ELSE.
