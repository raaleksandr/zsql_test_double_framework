*&---------------------------------------------------------------------*
*& Report ZTESTABLE_DB_EXAMPLE_HELLWORLD
*&---------------------------------------------------------------------*
*& Program with simple examples of using of ZTESTABLE_DB_LAYER
*& library
*&---------------------------------------------------------------------*
REPORT ztestable_db_example_hellworld.
...
*?</asx:abap>
  PRIVATE SECTION.
    ...
    METHODS: setup,
      simple_select FOR TESTING RAISING zcx_testable_db_layer,
      more_complicated_select FOR TESTING RAISING zcx_testable_db_layer,
      select_with_params FOR TESTING RAISING zcx_testable_db_layer,
      select_for_all_entries FOR TESTING RAISING zcx_testable_db_layer.
ENDCLASS.
