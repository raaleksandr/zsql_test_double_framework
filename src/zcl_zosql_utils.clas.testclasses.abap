...
CLASS ltc_testable_db_layer_utils IMPLEMENTATION.
  ...
  METHOD ends_with_positive.
    ...
    lv_result = zcl_zosql_utils=>check_ends_with( iv_sql       = 'SOME STRING ENDS WITH AND'
                                                  iv_ends_with = 'AND' ).
  ...
  METHOD ends_with_negative.
    ...
    lv_result = zcl_zosql_utils=>check_ends_with( iv_sql       = 'SOME STRING AND OTHER STRING NOT ENDS'
                                                  iv_ends_with = 'AND' ).
  ...
  METHOD ends_with_different_case.
    ...
    lv_result = zcl_zosql_utils=>check_ends_with( iv_sql       = 'Some String With And'
                                                  iv_ends_with = 'AND' ).
  ...
  METHOD delete_end_worde.
    ...
    lv_result = zcl_zosql_utils=>delete_end_word_if_equals( iv_sql_source         = 'SOME STRING WITH AND'
  ...
  METHOD delete_end_worde_no_delete.
    ...
    lv_result = zcl_zosql_utils=>delete_end_word_if_equals(
