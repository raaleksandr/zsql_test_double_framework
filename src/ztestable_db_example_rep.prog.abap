...
*& The program uses ztestable_db_layer library to make code
...
*?</asx:abap>
  PRIVATE SECTION.
    ...
    METHODS: setup,
      customer_one_flight FOR TESTING RAISING zcx_testable_db_layer,
      name_of_first_carrier FOR TESTING RAISING zcx_testable_db_layer,
      favourite_carrier FOR TESTING RAISING zcx_testable_db_layer.
ENDCLASS.
...
CLASS ltc_unit_tests_on_prog IMPLEMENTATION.
  ...
  METHOD customer_one_flight.
    ...
    DATA: lt_scustom        TYPE TABLE OF scustom,
          ...
          lt_customid_range TYPE ztestable_db_example_cust_rng.
