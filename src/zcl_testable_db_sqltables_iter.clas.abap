class ZCL_TESTABLE_DB_SQLTABLES_ITER definition
  public
  create public .

public section.

  interfaces ZIF_TESTABLE_DB_ITERATOR .
  ...
  methods GET_ITERATOR_POSITION_OBJECT
    returning
      value(RO_ITERATOR_POS) type ref to ZCL_TESTABLE_DB_SQLTAB_ITERPOS
    raising
      ZCX_TESTABLE_DB_LAYER .
...
private section.
  ...
  types:
    BEGIN OF ty_dataset_with_position,
      ...
      dataset_alias     TYPE string,
      type_of_join      TYPE i,
      iterator          TYPE REF TO zif_testable_db_iterator,
  ...
  types:
    BEGIN OF TY_OUTER_JOIN_ADD_ITER,
           sqltables_iter  TYPE REF TO zcl_testable_db_sqltables_iter,
...
CLASS ZCL_TESTABLE_DB_SQLTABLES_ITER IMPLEMENTATION.
  ...
  method GET_DATA_SET_LIST.
    ...
    zcl_testable_db_layer_utils=>move_corresponding_table( EXPORTING it_table_src  = mt_datasets_with_position
  ...
  METHOD get_iterator_position_object.
    ...
    DATA: ld_ref_to_line         TYPE REF TO data,
          ...
          lt_data_sets_outer_join TYPE ZCL_TESTABLE_DB_SQLTAB_ITERPOS=>ty_data_sets.
  ...
  METHOD zif_testable_db_iterator~get_current_record_unique_id.
  ...
  method ZIF_TESTABLE_DB_ITERATOR~IS_EMPTY.
  ...
  method ZIF_TESTABLE_DB_ITERATOR~MOVE_TO_FIRST.
  ...
  method ZIF_TESTABLE_DB_ITERATOR~MOVE_TO_NEXT.
  ...
  method ZIF_TESTABLE_DB_ITERATOR~RECORD_IS_LAST.
  ...
  method _ADD_DATASET.
    ...
    IF zcl_testable_db_view_iterator=>is_database_view( iv_dictionary_name ) = abap_true.
      CREATE OBJECT ls_dataset_with_position-iterator TYPE zcl_testable_db_view_iterator
        EXPORTING
          io_zosql_test_environment = mo_zosql_test_environment
          iv_view_name              = iv_dictionary_name.
    ELSE.
      CREATE OBJECT ls_dataset_with_position-iterator TYPE zcl_testable_db_table_iterator
        EXPORTING
          io_zosql_test_environment = mo_zosql_test_environment
  ...
  method _ADD_JOIN_CONDITION.
    ...
    CREATE OBJECT ls_join_condition-parser TYPE zcl_testable_db_join_cd_parser.
  ...
  METHOD _add_left_join_iter.
    ...
    DATA: lt_datasets_with_records  LIKE mt_datasets_with_position,
          ...
          lo_next_sqltable_iter     TYPE REF TO zcl_testable_db_sqltables_iter,
  ...
  method _CHECK_CONDITIONS_CURRENT_POS.
    ...
    DATA: lo_current_iterator_pos TYPE REF TO zcl_testable_db_sqltab_iterpos,
  ...
  METHOD _init_outer_join_add_mode.
    ...
    LOOP AT mt_outer_join_add_chain ASSIGNING <ls_outer_join_add_elem>.
      IF <ls_outer_join_add_elem>-sqltables_iter->zif_testable_db_iterator~move_to_first( ) <> abap_true.
  ...
  METHOD _NEXT_POS_OUTER_JOIN_ADD_MODE.
    ...
    rv_next_position_found = ls_outer_join_add_iter-sqltables_iter->zif_testable_db_iterator~move_to_next( ).
