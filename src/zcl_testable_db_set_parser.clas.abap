class ZCL_TESTABLE_DB_SET_PARSER definition
  public
...
public section.
  ...
  methods CONSTRUCTOR
    importing
      ...
      !IO_PARAMETERS type ref to ZCL_TESTABLE_DB_PARAMETERS .
  methods PARSE_SET
    importing
...
private section.
  ...
  data MO_PARAMETERS type ref to ZCL_TESTABLE_DB_PARAMETERS .
  data MT_SET_FIELDS  TYPE STANDARD TABLE OF ty_set_field WITH KEY fieldname.
ENDCLASS.



CLASS ZCL_TESTABLE_DB_SET_PARSER IMPLEMENTATION.
  ...
  METHOD parse_set.
    ...
    LOOP AT ltd_words INTO lv_word.
      ...
      IF lv_value_expected = abap_true.
        ls_set_field-value_part = zcl_testable_db_layer_utils=>clear_quotes_from_value( lv_word ).
  ...
  method UPDATE_RECORD.
    ...
    LOOP AT mt_set_fields ASSIGNING <ls_set_field>.
      ...
      IF sy-subrc <> 0.
        MESSAGE e065 WITH <ls_set_field>-fieldname INTO zcl_testable_db_layer_utils=>dummy.
