class ZCL_ZOSQL_FACTORY definition
  public
  create public .

public section.

  interfaces ZIF_ZOSQL_FACTORY .
  ...
  class-methods GET_INSTANCE
    returning
      value(RO_INSTANCE) type ref to ZIF_ZOSQL_FACTORY .
...
CLASS ZCL_ZOSQL_FACTORY IMPLEMENTATION.
  ...
  method GET_INSTANCE.
    CREATE OBJECT ro_instance TYPE zcl_zosql_factory.
  endmethod.
  ...
  method ZIF_ZOSQL_FACTORY~GET_DATABASE_LAYER.
    IF zif_zosql_factory~test_mode = abap_true.
      mo_zosql_test_environment = zif_zosql_factory~get_test_environment( ).
  ...
  method ZIF_ZOSQL_FACTORY~GET_ONE_VIRTUAL_TABLE.
  ...
  method ZIF_ZOSQL_FACTORY~GET_TEST_ENVIRONMENT.
  ...
  method ZIF_ZOSQL_FACTORY~TEST_MODE_OFF.
    zif_zosql_factory~test_mode = abap_false.
  endmethod.


  method ZIF_ZOSQL_FACTORY~TEST_MODE_ON.
    zif_zosql_factory~test_mode = abap_true.
  endmethod.
ENDCLASS.
