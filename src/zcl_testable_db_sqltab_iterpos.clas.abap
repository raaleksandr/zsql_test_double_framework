class ZCL_TESTABLE_DB_SQLTAB_ITERPOS definition
  public
  create public .
...
CLASS ZCL_TESTABLE_DB_SQLTAB_ITERPOS IMPLEMENTATION.
  ...
  method GET_DATA_SET_LIST.
    ...
    zcl_testable_db_layer_utils=>move_corresponding_table( EXPORTING it_table_src  = mt_data_sets_data
  ...
  method GET_FIELD_REF_OF_DATA_SET.
    ...
    lv_fieldname = zcl_testable_db_layer_utils=>to_upper_case( iv_fieldname ).
