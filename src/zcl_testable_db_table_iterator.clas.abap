class ZCL_TESTABLE_DB_TABLE_ITERATOR definition
  public
  create public .
...
CLASS ZCL_TESTABLE_DB_TABLE_ITERATOR IMPLEMENTATION.
  ...
  method ZIF_TESTABLE_DB_ITERATOR~CLONE.

    DATA: lo_clone_table_iterator TYPE REF TO zcl_testable_db_table_iterator,
  ...
  method ZIF_TESTABLE_DB_ITERATOR~CREATE_EMPTY_RECORD_AS_REF.
  ...
  method ZIF_TESTABLE_DB_ITERATOR~DELETE_RECORD_BY_UNIQUE_ID.
  ...
  METHOD zif_testable_db_iterator~get_current_record_ref.
    ...
    IF mv_current_record <= mv_num_lines.
      ASSIGN mr_table_data_ref->* TO <lt_table_data>.
      rd_ref_to_data_of_current_rec = zif_testable_db_iterator~create_empty_record_as_ref( ).
