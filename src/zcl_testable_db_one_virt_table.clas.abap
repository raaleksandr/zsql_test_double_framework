class ZCL_TESTABLE_DB_ONE_VIRT_TABLE definition
  public
  create public .
...
CLASS ZCL_TESTABLE_DB_ONE_VIRT_TABLE IMPLEMENTATION.
  ...
  method GET_DATA.
    ...
    ASSIGN m_virtual_table_buffer_ref->* TO <lt_table_buffer>.
    zcl_testable_db_layer_utils=>move_corresponding_table( EXPORTING it_table_src  = <lt_table_buffer>
