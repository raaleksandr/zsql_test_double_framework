class ZCL_TESTABLE_DB_WHERE_PARSER definition
  public
...
CLASS ZCL_TESTABLE_DB_WHERE_PARSER IMPLEMENTATION.
  ...
  METHOD is_parameter_compared_as_range.
    ...
    DATA: lo_where_parser TYPE REF TO zcl_testable_db_where_parser.
  ...
  method ZIF_TESTABLE_DB_SQLCOND_PARSER~GET_PARSER_INSTANCE.
    CREATE OBJECT ro_parser TYPE zcl_testable_db_where_parser
      EXPORTING
